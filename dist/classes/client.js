...
export class ExtendedClient extends Client {
    constructor() {
        ...
        this.prefix = ',,';
        this.owners = ['1162042652049555557', '1162042652049555557'];
        this.admins = [' ', ' '];
        this.db = {
        ...
        this.connectToGateway = () => (this.login('MTM0NzYxNDI0NTAzNDAwMDQ2Nw.Gzv7yu.mcdqC1iYFFfv25v3eGzM_GK767WbfojdK2vuNk'), this);
