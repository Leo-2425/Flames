...
export default class Help extends Command {
  ...
  execute = async (client: ExtendedClient, ctx: Context) => {
    ...
    const embed = client
      ...
      .img(
        'https://media.discordapp.net/attachments/1210593301552697396/1250715186185240596/fuego.png?ex=666bf2c9&is=666aa149&hm=a6c526a2e27255998582225feca01e0cfa840d91375d24bfe1d43e55bd2b81c2&=&format=webp&quality=lossless',
      )
      .footer({
        text: 'By Reo | Use (cmd -h) for command info',
      });
